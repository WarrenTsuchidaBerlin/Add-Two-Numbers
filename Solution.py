...
class Solution:
    def addTwoNumbers(self, l1: ListNode, l2: ListNode) -> ListNode:
        ...
        #Note that this is just a temporary node that simplifies the list construction.
        ...
        tail = dummyHead
        #We need this variable to keep track of any carry-over that results from summing digits that we will do later.
        carry = 0

        #while loop that continues as long as we have more nodes to process in either l1 or l2 or if there is carry-over.
        while l1 is not None or l2 is not None or carry != 0:
            ...
            digit = sum % 10
            #Carry-over for the next sum is calculated by performing interger division of the sum by 10.
            carry = sum // 10

            #Here we build our output/answer. 
            #A new node is created with the value of digit that was assigned on line 24.
            newNode = ListNode(digit)
            #Here we are building our output list. We append newNode to the output list.
            #this line is linking the new node to the end of the result list, making it the new last node in the list.
            tail.next = newNode
        ...
        #Code would work fine without this line, and it's more of a precautionary measure.
        dummyHead.next = None
